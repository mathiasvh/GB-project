...
<form method="post">
Top <input type="number" style="width: 50px" name ="top_nb" min = 0 step = 5> books by number of awards in genre 
        ...
        <input style="margin-left: 10px" type ="submit" name="search_books" value="Search" ><br>
</form>
<br>
