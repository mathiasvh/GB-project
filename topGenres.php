...
<form method="post">
    Top <input type="number" style="width: 50px" name ="top_nb" min = 0 step = 5> genres by number of
          <input type="radio" name="by" value = 'awards' checked="checked"> awards 
          <input type="radio" name="by" value = 'books' > books 
        <input style="margin-left: 10px" type ="submit" name="search_genres" value="Search" >
        <br>
</form>
<br>
