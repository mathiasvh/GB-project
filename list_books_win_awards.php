...
$controller = new gb\controller\WinAwardController();
$controller->process();
...
<ul>
    ...
    <li class="selecteditem"><a href="list_books_win_awards.php">Books & awards</a></li>
...
<form method="post">
From time: <input type="date" name ="from_time" >
To time: <input type="date" name ="to_time" >            
<input type ="submit" name="search" value="Search" >
</form>
<br>
<?php
    $list = $controller->getSearchResult();
    print (count($list)) . " results found";
    if (count($list) > 0) {
?>
...
<?php
 ...
 ?>
       <tr>
	    <td><?php echo $tmp->getCountry(); ?></td>
        <td><?php echo $tmp->getGenre(); ?></td>
        <td><?php echo $tmp->getBooks(); ?></td>
	</tr>     
<?php        
        }
?>
